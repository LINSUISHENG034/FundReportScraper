...
class DownloadTaskModel(Base):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "failed_results": json.loads(self.failed_results) if self.failed_results else [],
    ...
    def from_download_task(cls, task) -> 'DownloadTaskModel':
        ...
        return cls(
            ...
            completed_ids=json.dumps(task.completed_ids) if task.completed_ids else None,
            failed_results=json.dumps(task.failed_results) if task.failed_results else None,
    ...
    def update_from_download_task(self, task):
        ...
        self.completed_ids = json.dumps(task.completed_ids) if task.completed_ids else None
        self.failed_results = json.dumps(task.failed_results) if task.failed_results else None
...
def get_download_task_table_info():
    ...
    return {
        ...
        "columns": [
            ...
            {"name": "report_ids", "type": "Text", "description": "JSON array of report IDs"},
            ...
            {"name": "completed_ids", "type": "Text", "description": "JSON array of completed IDs"},
            {"name": "failed_results", "type": "Text", "description": "JSON array of failed results"},
