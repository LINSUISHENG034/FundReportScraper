...
class Downloader:
    ...
    def __init__(self, timeout: int = 120):
        ...
        self.headers = {"User-Agent": settings.scraper.user_agent}
    ...
    def download_to_file(self, url: str, destination: Path) -> dict:
        ...
        try:
            ...
            with requests.get(
                ...
                bound_logger.info("downloader.download.success", file_size=file_size)
            ...
            bound_logger.error(
                "downloader.download.http_error", status_code=e.response.status_code
            )
            return {
                "success": False,
            ...
            bound_logger.error("downloader.download.request_exception", error=str(e))
            return {
                "success": False,
